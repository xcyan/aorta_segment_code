...
weights.hidhid = 0.01*randn(params.ws, params.ws, params.numch, params.numhid);
...
for t = 1:maxiter,
    ...
    ts_epoch = tic;
    for b = 1:numbatch,
        % Selects one example for stoch descent (basically does nothing because
        % batchsize is 1 though.
